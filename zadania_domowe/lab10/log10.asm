...
;        st = [st0] = [log2(10)]
         ...
         fld qword [eax]  ; *(double*)eax = *(double*)addr_y = y -> st  ; fpu load floating-point

;        st = [st0, st1] = [1.0, log2(10)]  ; fpu stack

         fld qword [eax + 8]  ; *(double*)(eax + 8) = *(double*)addr_x = x -> st  ; fpu load floating-point
         
;        st = [st0, st1, st2] = [x, 1.0, log2(10)]  ; fpu stack

;        fyl2x  ; st(1) := st(1)*log2[st(0)] i zdejmij

         fyl2x  ; [st0, st1] => [st0, st1*log2(st0)] => [st1*log2(st0)] = log2(x)

;        st = [st0, st1] = [log2(x), log2(10)]

         fdiv st1  ; [st0, st1] => st0 = st0/st1 = log2(x)/log2(10) = log10(x)
